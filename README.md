...
This project is a shared hub for reusable custom instructions and skills that can be applied across different AI coding models and workflows.
...
Copy or reference these files when configuring another model or workflow. Keep the guidance general, explicit, and portable so it works across providers.
